...
on run argv -- argv is for 'run script with parameters' or osascript cli arguments
	script this
		property name : "0017" -- number identifier of this test suite
		property description : "Initially new, nonexistent bookmarks file; choose nonempty file"
		...
		on main(argv)
			...
			-- name).
			--
			-- No initial default bookmarks file for this test (default from `init()`)
			copy_initial_file("b-urls-chosen.txt") -- chosen bookmarks file (selected by test)
