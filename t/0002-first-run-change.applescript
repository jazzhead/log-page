...
on run argv -- argv is for 'run script with parameters' or osascript cli arguments
	script this
		property name : "0002" -- number identifier of this test suite
		property description : "First Run - Change Settings"
		...
		on main(argv)
			...
			--
			init(false) -- false = trigger first-run by not writing an initial prefs file.
