...
on run argv -- argv is for 'run script with parameters' or osascript cli arguments
	script this
		property name : "0009" -- number identifier of this test suite
		property description : "Bookmarks file w/two categories, one w/two subcategories"
